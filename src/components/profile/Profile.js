...
import { Avatar, Badge, Button, Grid, InputAdornment, TextField, Typography, useMediaQuery } from '@material-ui/core';
            ...
            <Grid container direction={matchSm ? 'column' : 'row'} className={classes.container} justify="center" alignItems={matchSm ? 'center' : undefined}>
                ...
                >
                    <Grid container direction="column" alignItems="center" justify="center">
                        <Grid item>
                                <input type="file" onChange={onFileChange} style={{display:"none"}} id="fileUpload"  />
                            <Badge
                                badgeContent={
